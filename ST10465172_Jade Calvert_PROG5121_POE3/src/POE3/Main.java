...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Create a password: It must contain at least 8 characters, an uppercase letter, a lowercase letter, a number, and a special character. ");
            scanner.nextLine();
